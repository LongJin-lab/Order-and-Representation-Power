...
def parse_args():
    ...
    parser.add_argument('--REPRODUCIBLE_RUN', type=str2bool, default=True, help="Whether to fix seeds and disable CUDA benchmark mode.")
    ...
    parser.add_argument('--TRAIN_NOI_COE', type=float, required=False, default=None, help="Description for train_noi_coe.")
