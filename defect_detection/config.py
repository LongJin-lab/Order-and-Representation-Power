class Config:
    ...
    INPUT_HEIGHT = None
    INPUT_CHANNELS = None
    TRAIN_NOI_COE = None  # Add this line
    ...
    def merge_from_args(self, args):
        ...
        if args.TRAIN_NOI_COE is not None: self.TRAIN_NOI_COE = args.TRAIN_NOI_COE
    ...
    def get_as_dict(self):
        params = {
            ...
            "DILATE": self.DILATE,
            "TRAIN_NOI_COE": self.TRAIN_NOI_COE,  # Add this line
        }
        return params
...
def load_from_dict(dictionary):
    ...
    cfg.TRAIN_NOI_COE = dictionary.get("TRAIN_NOI_COE", None)  # Add this line
