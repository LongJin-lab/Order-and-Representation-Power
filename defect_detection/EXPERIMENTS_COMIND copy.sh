...
run_COMIND_EXPERIMENTS()
{
    ...
    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 1.0 "${GPUS[@]}" # Figure 7
    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.7 "${GPUS[@]}" # Figure 7    

    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.5 "${GPUS[@]}" # Figure 7
    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.5 "${GPUS[@]}" # Figure 7
    # train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.5 ${GPUS[0]} # Figure 9

    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.01 "${GPUS[@]}" # Figure 7
    # train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.01 ${GPUS[0]} # Figure 9

    # train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.4 "${GPUS[@]}" # Figure 7
    # train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.4 ${GPUS[0]} # Figure 9

    train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.05 "${GPUS[@]}" # Figure 7
    train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.05 ${GPUS[0]} # Figure 9

    train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.3 "${GPUS[@]}" # Figure 7
    train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.3 ${GPUS[0]} # Figure 9

    train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.1 "${GPUS[@]}" # Figure 7
    train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.1 ${GPUS[0]} # Figure 9

    train_KSDD $SAVE_IMAGES N_ALL  $RESULTS_PATH 7 33 33 50 1 0.01 1 True  2 1 True  True  True 0.2 "${GPUS[@]}" # Figure 7
    train_single $SAVE_IMAGES KSDD2 $KSDD2_PATH N_246 $RESULTS_PATH 15 -1 246 50 0.01 1 1 True  2 3 True  True  True 0.2 ${GPUS[0]} # Figure 9
...
run_COMIND_EXPERIMENTS ./results-comind/NewLog True "${GPUS[@]}"
