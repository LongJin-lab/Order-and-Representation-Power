...
parser = argparse.ArgumentParser(description='ZeorSNet CIFAR')
parser.add_argument('--lr', default=0.2, type=float, help='initial learning rate')#TODO 0.000125 #0.1
...
parser.add_argument('--arch', '-a', default='convnext_conver_small_narrow', type=str)#ZeroSAny20settings#convnext_conver_nano_hnf#convnext_conver_tiny#convnext_tiny
...
if __name__ == '__main__':
    ...
    try:
        ...
        if exc.errno == errno.EEXIST and os.path.isdir(path_base):
            ...
            raise
# opt = Optimizer(sys.argv[1],api_key="KbJPNIfbsNUoZJGJBSX4BofNZ")#,experiment_class = "OfflineExperiment",)
  
    if 1:
    # for experiment in opt.get_experiments(
    #     project_name="over3orders-Net20Datasets_RestartExpLearnAbs-Tuning",
    #     # offline_directory=path_base,
    #     ):
    #     args =parser.parse_known_args()[0]
        
        
    #     args.IniDecay=experiment.get_parameter("IniDecay")
    #     args.CoesLR=experiment.get_parameter("CoesLR")
        
        # args.settings=experiment.get_parameter("settings")
        # args.dataset=experiment.get_parameter("dataset")
        # print('IniDecay,settings',args.IniDecay,args.settings)    
        Datasets = ['svhn','cifar10','cifar100']
        top1_pertur_test_c10, test_top1_acc_c10, top1_pertur_test_c100,test_top1_acc_c100,top1_pertur_test_svhn,test_top1_acc_svhn=0,0,0,0,0,0
        ...
        if 1:
            ...
            # experiment = OfflineExperiment(
                ...
                project_name="over3orders-ConvNextCIFAR-Tuning",
        ...
        #TODO: named_parameters may lose some unnamed parameters
            ...
            if 'convnext' in args.arch:
                ...
                ], lr=0.0001, weight_decay=0.05,eps=5e-9)#lr=0.001*args.lr
            else:
        ...
        top1_pertur_test_SumDatasets = top1_pertur_test_c10+top1_pertur_test_c100+top1_pertur_test_svhn    
        test_top1_acc_SumDatasets = test_top1_acc_c10 +test_top1_acc_c100+test_top1_acc_svhn
        experiment.log_metric("top1_pertur_test_SumDatasets", top1_pertur_test_SumDatasets)
        experiment.log_metric("test_top1_acc_SumDatasets", test_top1_acc_SumDatasets)
        experiment.log_metric("Test_SumDatasets", top1_pertur_test_SumDatasets+test_top1_acc_SumDatasets)
experiment.end()
