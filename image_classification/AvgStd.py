    ...
    for parent, _, fileNames in os.walk(root_dir):
        for name in fileNames:
            ...
            if ext:  
                ...
                if name.endswith(tuple(ext)) and 'Settings' in name:
...
if __name__ == '__main__':
    ...
    data_path = '/media_HDD_1/lab415/clm/OverThreeOrders/OverThreeOrders/CIFAR/runs/cifar100/ConvNext3runs/'#'/media/bdc/clm/OverThreeOrders/CIFAR/runs/cifar10/ZeroSNet/'#'/media/bdc/clm/OverThreeOrders/CIFAR/runs/mnist/ZeroSNet/'
    ...
    type = 'C100_NoAdvFromCsv_AblasCQ3090'
    NoiseType = [
    'PGD',
    'FGM',
    'PGD',
    ...
    for path in paths_list:
        ...
        ablation = path.split('Settings')[1].split('lr')[0]

        # ablation = 'Cosep200_0914RobAB'
    ...
    df['Ablation'] = df['Ablation'].replace(['mnistConvStride2Learn',
                                             ...
                                             'mnistConvStride2ResLike','ab','Rob','const', ],['Conv',
                                                                         'BN-ReLU-conv, sharing',
                                                                         'Element transfering',
                                                                         'Pool-conv, Dirac',
                                                                         'Conv, sharing',
                                                                         'BN-ReLU-conv','AB ','Rob ','Constant'])
    df['Noise Type'] = df['Noise Type'].replace(['const', 'rand','randn'],['Constant','Uniform','Gaussian'])
